...
<p align="left">
  <p>Configuração dos Cookies, adiciona e limpa os cookies</p>
  <img width="400" height="367" alt="image" src="https://github.com/user-attachments/assets/ec58b238-d7ad-4909-b9f9-529a7b7150a5" style="display: inline-block;"/>

  <p>Interceptador adiciona os headers de segurança (CSRF e Fingerprint) nas requisições</p>
